...
export default function Hero() {
  return (
    <section id="home" className="relative w-full overflow-hidden bg-royal-deep">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-6 px-5 pb-10 pt-20 md:min-h-[64vh] md:pt-24 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10 lg:px-8">
        {/* Left — headline */}
        <div className="max-w-xl">
          <OfferCountdown />

          <h1 className="mt-3 font-serif text-[1.85rem] font-semibold leading-[1.1] tracking-tight text-white sm:text-[2.3rem] lg:text-[2.7rem]">
            Best <span className="text-brand-orange">Kashmir Tour Packages</span> for Holiday &amp;
            Trip in 2026
          </h1>

          <p className="mt-2.5 text-sm font-medium text-white/85 sm:text-base">
            {heroOffer.ratingNote}
          </p>

          <p className="mt-2.5 max-w-lg text-sm leading-relaxed text-white/75 sm:text-[0.95rem]">
            Book customized{" "}
